...
// Fetch chickens from the database
$query = "SELECT * FROM chickens";
$result = mysqli_query($conn, $query);
$chickens = mysqli_fetch_all($result, MYSQLI_ASSOC);
?>
...
<body>
  ...
  <div class="container">
    <main class="grid">
      <?php foreach ($chickens as $index => $chicken): ?>
        <article>
          <img src="<?php echo $chicken['image']; ?>" alt="Sample photo">
          <div class="text">
            <p><strong><?php echo $chicken['name']; ?></strong></p>
            <p><strong>Available: </strong><?php echo $chicken['available']; ?></p>
            <p><strong>Selling Price: </strong><?php echo $chicken['price']; ?></p>
            <p><strong>Location: </strong><?php echo $chicken['location']; ?></p>
            <form action="add_to_cart.php" method="post">
              <input type="hidden" name="item_index" value="<?php echo $index; ?>">
              <input type="hidden" name="id" value="<?php echo $chicken['id']; ?>">
              <input type="hidden" name="name" value="<?php echo $chicken['name']; ?>">
              <input type="hidden" name="price" value="<?php echo $chicken['price']; ?>">
              <input type="hidden" name="image" value="<?php echo $chicken['image']; ?>">
