...
<body>
  ...
  <div class="container">
    <main class="grid">
      <?php foreach ($cows as $index => $cow): ?>
        <article>
          <img src="<?php echo $cow['image']; ?>" alt="Sample photo">
          <div class="text">
            <p><strong><?php echo $cow['name']; ?></strong></p>
            <p><strong>Available: </strong><?php echo $cow['available']; ?></p>
            <p><strong>Selling Price: </strong><?php echo $cow['price']; ?></p>
            <p><strong>Location: </strong><?php echo $cow['location']; ?></p>
            <form action="add_to_cart.php" method="post">
              <input type="hidden" name="item_index" value="<?php echo $index; ?>">
              <input type="hidden" name="id" value="<?php echo $cow['id']; ?>">
              <input type="hidden" name="name" value="<?php echo $cow['name']; ?>">
              <input type="hidden" name="price" value="<?php echo $cow['price']; ?>">
              <input type="hidden" name="image" value="<?php echo $cow['image']; ?>">
