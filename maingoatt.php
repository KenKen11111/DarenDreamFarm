...
$goats = mysqli_fetch_all($result, MYSQLI_ASSOC);
?>
...
<body>
  ...
  <div class="container">
    <main class="grid">
      <?php foreach ($goats as $index => $goat): ?>
        <article>
          <img src="<?php echo $goat['image']; ?>" alt="Sample photo">
          <div class="text">
            <p><strong><?php echo $goat['name']; ?></strong></p>
            <p><strong>Available: </strong><?php echo $goat['available']; ?></p>
            <p><strong>Selling Price: </strong><?php echo $goat['price']; ?></p>
            <p><strong>Location: </strong><?php echo $goat['location']; ?></p>
            <form action="add_to_cart.php" method="post">
              <input type="hidden" name="item_index" value="<?php echo $index; ?>">
              <input type="hidden" name="id" value="<?php echo $goat['id']; ?>">
              <input type="hidden" name="name" value="<?php echo $goat['name']; ?>">
              <input type="hidden" name="price" value="<?php echo $goat['price']; ?>">
              <input type="hidden" name="image" value="<?php echo $goat['image']; ?>">
