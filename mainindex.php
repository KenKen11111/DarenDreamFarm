  ...
  <div class="container">
    <main class="grid">
      <?php foreach ($animals as $index => $animal): ?>
        <article>
          <img src="<?php echo $animal['image']; ?>" alt="Sample photo">
          <div class="text">
            <p><strong><?php echo $animal['name']; ?></strong></p>
            <p><strong>Available: </strong><?php echo $animal['available']; ?></p>
            <p><strong>Selling Price: </strong><?php echo $animal['price']; ?></p>
