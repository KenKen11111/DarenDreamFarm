...
<body>
  ...
  <div class="container">
    <main class="grid">
      <?php foreach ($ducks as $index => $duck): ?>
        <article>
          <img src="<?php echo $duck['image']; ?>" alt="Sample photo">
          <div class="text">
            <p><strong><?php echo $duck['name']; ?></strong></p>
            <p><strong>Available: </strong><?php echo $duck['available']; ?></p>
            <p><strong>Selling Price: </strong><?php echo $duck['price']; ?></p>
            <p><strong>Location: </strong><?php echo $duck['location']; ?></p>
            <form action="add_to_cart.php" method="post">
              <input type="hidden" name="item_index" value="<?php echo $index; ?>">
              <input type="hidden" name="id" value="<?php echo $duck['id']; ?>">
              <input type="hidden" name="name" value="<?php echo $duck['name']; ?>">
              <input type="hidden" name="price" value="<?php echo $duck['price']; ?>">
              <input type="hidden" name="image" value="<?php echo $duck['image']; ?>">
